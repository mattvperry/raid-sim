...
/* raid-controller.c */
extern void raid_controller_gen_send( tw_lpid dest, Event event_type, tw_stime event_length, tw_lp* lp );
...
/* raid-io.c */
extern void raid_io_gen_send( tw_lpid dest, Event event_type, tw_stime event_length, tw_lp* lp );
